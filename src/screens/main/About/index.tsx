    ...
    >
      ...
      >
        ...
        <View style={styles.textPoints}>
          ...
          />
          <CustomText
            text={`Four Physical Stores in Lahore: Our flagship store in Gulberg, along with Three other locations in DHA, Barahra Town and Urdu Bazar, cater to book lovers across the city. Notably, Readings DHA is home to the largest and most modern bookstore and coffee shop in Pakistan.`}
            lineHeight={20}
            style={{ textAlign: "justify" }}
            size={14}
          />
